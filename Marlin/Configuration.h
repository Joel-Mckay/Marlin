...
#define CUSTOM_MACHINE_NAME "3D Printer Infinity hardware"

// Define this to set a unique identifier for this printer, (Used by some programs to differentiate between machines)
// You can use an online service to generate a random UUID. (eg http://www.uuidgenerator.net/version4)
#define MACHINE_UUID "1234567890abc-def0-1234-56789abcdef0"
...
#define DEFAULT_ACCELERATION          30    // X, Y, Z and E acceleration
#define DEFAULT_RETRACT_ACCELERATION  30    // E acceleration for retracts
#define DEFAULT_TRAVEL_ACCELERATION   30    // X, Y, Z acceleration for tra
